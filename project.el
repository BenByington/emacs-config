...
(defun proj-cuda-build-dir (arch debug)
    (setq baseDir (git-base-dir))
    (setq relDir "Sequel/cuda/Prototypes/")
    (cond ((string= arch "gcc")    (setq archDir "build/x86_64/"))
	  (t                       (setq archDir "invalid-arch"))
    )
    (if debug (setq buildDir "Debug_gcc") (setq buildDir "Release_gcc"))
    (when (file-directory-p (concat baseDir relDir)) 
          (setq return (concat baseDir relDir archDir buildDir)))
)
...
(defun proj-cuda()        (interactive)(setq proj-subproj "CudaProt")    (fset 'proj-build-dir 'proj-cuda-build-dir)     (proj-update-parse-proj))
    ...
    (widget-create 'radio-button-choice
        ...
        :notify (lambda (widget &rest ignore)
		    (cond ((string= (widget-value widget) "PPA") (proj-ppa))
			  ((string= (widget-value widget) "Cuda") (proj-cuda))
